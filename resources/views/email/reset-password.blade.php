                ...
                <table role="presentation" width="500" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="background-color:#E07B24;padding:36px 20px;text-align:center;">
                            <img src="{{ asset('images/WhatsApp Image 2026-09-13 at 11.06.59 AM.jpeg') }}" alt="مساحاتي" width="180"
                    ...
                    <tr>
                        <td
                            style="padding:20px 40px 40px;text-align:center;background-image:url('{{ asset('images/masahati-watermark-center.png') }}');background-repeat:no-repeat;background-position:center top;background-size:340px auto;">
