    ...
    <tr>
      <td align="center">
        <table role="presentation" width="500" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 10px 40px rgba(224,123,36,0.18);">
          ...
          <!-- المحتوى -->
          <tr>
            <td style="padding:20px 40px 40px;text-align:center;background-image:url('{{ asset('images/masahati-watermark-center.png') }}');background-repeat:no-repeat;background-position:center top;background-size:340px auto;">
              ...
              <table role="presentation" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center">
                    <a href="{{ $url }}" style="background-color:#E07B24;color:#ffffff;text-decoration:none;font-size:16px;font-weight:700;padding:16px 48px;border-radius:12px;display:inline-block;box-shadow:0 8px 20px rgba(224,123,36,0.35);">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin:28px auto 0;">
                <tr>
                  <td style="background-color:#fdf3e9;border-radius:30px;padding:8px 20px;">
                    <span style="font-size:13px;color:#c9711f;font-weight:600;">⏱️ صالح لمدة {{ $expire }} دقيقة فقط</span>
                  </td>
                </tr>
              </table>
