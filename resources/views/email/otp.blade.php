        ...
        <tr>
            <td align="center">
                <table role="presentation" width="500" cellpadding="0" cellspacing="0"
                            ...
                            <table role="presentation" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:12px 26px;">
                                        <img src="{{ asset('images/WhatsApp Image 2026-09-13 at 11.06.59 AM.jpeg') }}" alt="مساحاتي"
                    ...
                    <tr>
                        <td
                            style="padding:10px 40px 40px;text-align:center;background-image:url('{{ asset('images/masahati-watermark-center.png') }}');background-repeat:no-repeat;background-position:center top;background-size:340px auto;">
                            ...
                            <table role="presentation" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td
                                        style="background-color:#fdf3e9;border:2px dashed #E07B24;border-radius:14px;padding:18px 44px;">
                                        <span
                                            style="font-size:36px;font-weight:700;letter-spacing:10px;color:#E07B24;direction:ltr;display:inline-block;font-family:'Courier New',monospace;">
                                            {{ $otp }}
                                        </span>
                                    </td>
                                </tr>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto 28px;">
                                <tr>
                                    <td style="background-color:#fdf3e9;border-radius:30px;padding:8px 20px;">
                                        <span style="font-size:13px;color:#c9711f;font-weight:600;">⏱️ صالح لمدة 10
                                            دقائق فقط</span>
                                    </td>
                                </tr>
                            </table>
